...
public class LoadLandscapeCommand implements Command {
    ...
    public LoadLandscapeCommand(PresentationInterface presentation, ViewInterface viewerFrame, XMLAccessor accessor) {
    ...
    @Override
    public void execute() {
        Command command = new OpenPresentationCommand(presentation, viewerFrame, accessor, "resources/landscape.xml");
        command.execute();
    }
} 