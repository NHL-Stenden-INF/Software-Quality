...
public class LoadStreetCommand implements Command {
    ...
    public LoadStreetCommand(PresentationInterface presentation, ViewInterface viewerFrame, XMLAccessor accessor) {
    ...
    @Override
    public void execute() {
        Command command = new OpenPresentationCommand(presentation, viewerFrame, accessor, "resources/street.xml");
        command.execute();
    }
} 